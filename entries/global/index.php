 ...
 */
function create_wordpress_theme_register_global_scripts() {
 ...
 */
function create_wordpress_theme_enqueue_global_scripts() {
 ...
 */
function create_wordpress_theme_enqueue_global_styles() {
